...
inc dword [dword 0x0]                                ;00000006  FF0500000000
inc dword [dword 0x0]                                ;0000000C  FF0500000000
push ebx                                             ;00000012  53
push esi                                             ;00000013  56
push edi                                             ;00000014  57
push  0x0                                            ;00000015  6A00
push dword [ebp+0x8]                                 ;00000017  FF7508
call 0xfffffeb0                                      ;0000001A  E891FEFFFF
...
call 0xfffff460                                      ;00000035  E826F4FFFF
...
call 0xfffff483                                      ;00000045  E839F4FFFF
inc dword [dword 0x0]                                ;0000004A  FF0500000000
push  0x0                                            ;00000050  6A00
push dword [ebp+0x8]                                 ;00000052  FF7508
call 0xfffffeb0                                      ;00000055  E856FEFFFF
...
call 0xfffffe50                                      ;00000069  E8E2FDFFFF
...
and dword [dword 0x0], 0x0                           ;000000E7  83250000000000
...
call 0xfffff483                                      ;000000FA  E884F3FFFF
push dword [ebp+0x8]                                 ;000000FF  FF7508
call 0x3881                                          ;00000102  E87A370000
dec dword [dword 0x0]                                ;00000107  FF0D00000000
...
call 0xfffff6bd                                      ;00000119  E89FF5FFFF
sub eax,[dword 0x0]                                  ;0000011E  2B0500000000
...
call 0xfffff4d6                                      ;0000013A  E897F3FFFF
push  0x8                                            ;0000013F  6A08
push  0x0                                            ;00000141  6A00
push  0x3                                            ;00000143  6A03
push  0x1                                            ;00000145  6A01
push esi                                             ;00000147  56
call 0x14d                                           ;00000148  E800000000
add esp, 0x14                                        ;0000014D  83C414
mov eax,[0x0]                                        ;00000150  A100000000
dec eax                                              ;00000155  48
mov [0x0],eax                                        ;00000156  A300000000
mov eax,[0x0]                                        ;0000015B  A100000000
dec eax                                              ;00000160  48
mov [0x0],eax                                        ;00000161  A300000000
mov eax,[0x0]                                        ;00000166  A100000000
imul eax,eax,dword 0xffffff                          ;0000016B  69C0FFFFFF00
add eax,[ebx+0x6]                                    ;00000171  034306
mov ecx,[dword 0x0]                                  ;00000174  8B0D00000000
mov esi,[dword 0x0]                                  ;0000017A  8B3500000000
...
call 0x3881                                          ;0000019F  E8DD360000
push dword [ebp+0x8]                                 ;000001A4  FF7508
dec dword [dword 0x0]                                ;000001A7  FF0D00000000
call 0x38ae                                          ;000001AD  E8FC360000
push ebx                                             ;000001B2  53
call 0xfffff483                                      ;000001B3  E8CBF2FFFF
push  0x0                                            ;000001B8  6A00
push dword [ebp-0x4]                                 ;000001BA  FF75FC
call 0x4b0f                                          ;000001BD  E84D490000
dec dword [dword 0x0]                                ;000001C2  FF0D00000000
pop edi                                              ;000001C8  5F
pop esi                                              ;000001C9  5E
pop ebx                                              ;000001CA  5B
leave                                                ;000001CB  C9
...
call 0x544e                                          ;00003F35  E814150000
...
mov ebx,[dword 0x0]                                  ;00003F61  8B1D00000000
...
call 0x44d4                                          ;00003F92  E83D050000
