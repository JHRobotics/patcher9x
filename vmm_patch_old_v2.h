...
#ifndef __VMM_PATCH_OLD_V2_H__INCLUDED__
#define __VMM_PATCH_OLD_V2_H__INCLUDED__

#include <patch.h>

/* original data for search */
const uint8_t vmm_patch_old_v2_orig[] = {
...
const uint8_t vmm_patch_old_v2_orig_check[] = {
...
/* new data to replace */
const uint8_t vmm_patch_old_v2[] = {
	0x83, 0xEC, 0x10, 0x53, 0x56, 0x57, 0x55, 0xA1, 0x64, 0x4F, 0x01, 0x00, 0x8B, 0x74, 0x24, 0x24, 
	0x40, 0xA3, 0x64, 0x4F, 0x01, 0x00, 0xA1, 0x6C, 0x4F, 0x01, 0x00, 0x40, 0xA3, 0x6C, 0x4F, 0x01, 
	0x00, 0x6A, 0x00, 0x56, 0xE8, 0x70, 0xFE, 0xFF, 0xFF, 0x89, 0xC5, 0x09, 0xED, 0x0F, 0x84, 0xB2, 
	0x01, 0x00, 0x00, 0x8B, 0x5D, 0x04, 0x53, 0xE8, 0x10, 0x0C, 0xFF, 0xFF, 0x83, 0xF8, 0x01, 0x19, 
...
const uint8_t vmm_patch_old_v2_modif[] = {
...
const cpatch_t vmm_patch_old_v2_cp = {
	vmm_patch_old_v2, sizeof(vmm_patch_old_v2),
	vmm_patch_old_v2_orig, sizeof(vmm_patch_old_v2_orig),
	vmm_patch_old_v2_orig_check, sizeof(vmm_patch_old_v2_orig_check),
	vmm_patch_old_v2_modif, sizeof(vmm_patch_old_v2_modif)
};

#endif /* __VMM_PATCH_OLD_V2_H__INCLUDED__ */
