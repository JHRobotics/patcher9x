#ifndef __VMM98_V4__PATCH_INCLUDED__
#define __VMM98_V4__PATCH_INCLUDED__

#include <patch.h>

const spatch_data_t vmm98_v4_data[] = {
...
const spatch_t vmm98_v4_sp = {409076, vmm98_v4_data};

#endif /*__VMM98_V4__PATCH_INCLUDED__*/
